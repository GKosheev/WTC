    ...
    try {
        ...
        await UserModel.updateOne({clubCardId: clubCardId}, {
            $set: {
                ...
                'subscription.subStarts': subPayment.subInfo.subStart, //TODO set full date with year using momentjs
                'subscription.subEnds': subPayment.subInfo.subEnd,      //TODO set full date with year using momentjs
