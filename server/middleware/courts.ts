...
export async function postCourtsMiddleware(req: Request, res: Response, next: NextFunction) {
  ...
  const [players, bodyError] = await postCourtsBodyValidation(req.body.members, req.body.guests, req.body.duration, req.body.splitPayments, req.params.courtType, req.params.courtId, req.params.date, req.params.time)
  if (bodyError)
